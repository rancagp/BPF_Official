                            ...
                            {[...Array(6)].map((_, index) => (
                                <div key={index} className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                                    <div className="animate-pulse space-y-4">
                                        ...
                                        <div className="h-10 bg-gradient-to-r from-[#080031]/5 to-[#FF0000]/5 rounded-lg mt-4"></div>
                                    </div>
                                </div>
                            ))}
                        </div>
                ...
                <div className="py-12 bg-gray-50">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center p-8 bg-white rounded-xl shadow-sm border border-red-100">
                            ...
                            <h3 className="text-lg font-medium text-[#080031] mb-2">Terjadi Kesalahan</h3>
                            <p className="text-[#080031]/60 mb-6">{error}</p>
                            <button
                                onClick={() => window.location.reload()}
                                className="inline-flex items-center px-6 py-2.5 text-sm font-medium rounded-lg shadow-sm text-white bg-[#080031] hover:bg-[#FF0000] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#FF0000] transition-colors duration-300"
                            >
                                Coba Lagi
                            </button>
                        </div>
