...
const DateTimeDisplay = () => {
    ...
    return (
        <div className="bg-white text-[#080031] text-xs border-b border-[#9B9FA7]/30">
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between py-2">
                    {/* Date */}
                    <div className="flex items-center text-[#080031]">
                        <i className="far fa-calendar-alt mr-2 text-[#FF0000]"></i>
                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        <div className="flex items-center bg-[#F8F8F8] px-3 py-1 rounded-md">
                            <span className="w-14 text-right font-semibold text-[#080031]">{timezones.jakarta}</span>
                            <span className="ml-2 w-10 font-medium">{currentTimeJKT}</span>
                        </div>
                        <div className="flex items-center bg-[#F8F8F8] px-3 py-1 rounded-md">
                            <span className="w-12 text-right font-semibold text-[#080031]">{timezones.tokyo}</span>
                            <span className="ml-2 w-10 font-medium">{currentTimeTKY}</span>
                        </div>
                        <div className="flex items-center bg-[#F8F8F8] px-3 py-1 rounded-md">
                            <span className="whitespace-nowrap font-semibold text-[#080031]">{timezones.hongkong}</span>
                            <span className="ml-2 w-10 font-medium">{currentTimeHK}</span>
                        </div>
                        <div className="flex items-center bg-[#F8F8F8] px-3 py-1 rounded-md">
                            <span className="w-14 text-right font-semibold text-[#080031]">{timezones.newyork}</span>
                ...
                <div className="md:hidden flex items-center space-x-3 overflow-x-auto py-2 -mx-4 px-4">
                    <div className="flex items-center bg-[#F8F8F8] px-2 py-1 rounded-md flex-shrink-0">
                        <span className="w-8 text-right font-semibold text-[#080031]">JKT</span>
                        <span className="ml-1 font-medium">{currentTimeJKT}</span>
                    </div>
                    <div className="flex items-center bg-[#F8F8F8] px-2 py-1 rounded-md flex-shrink-0">
                        <span className="w-8 text-right font-semibold text-[#080031]">TKY</span>
                        <span className="ml-1 font-medium">{currentTimeTKY}</span>
                    </div>
                    <div className="flex items-center bg-[#F8F8F8] px-2 py-1 rounded-md flex-shrink-0">
                        <span className="w-8 text-right font-semibold text-[#080031]">HKG</span>
                        <span className="ml-1 font-medium">{currentTimeHK}</span>
                    </div>
                    <div className="flex items-center bg-[#F8F8F8] px-2 py-1 rounded-md flex-shrink-0">
                        <span className="w-8 text-right font-semibold text-[#080031]">NYC</span>
