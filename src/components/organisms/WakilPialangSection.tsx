...
export default function WakilPialangSection({
  ...
  if (isLoading) {
    return (
      <div className={`${className} py-16 bg-gray-50`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {showHeader && (
            <div className="text-center mb-12">
              <div className="animate-pulse h-10 bg-gray-200 rounded-full w-64 mx-auto mb-4"></div>
  ...
  return (
    <div className={`${className} py-4 bg-gray-50`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {showHeader && (
