...
export default function NewsCard({
    ...
    const cardClasses = {
        default: 'group flex flex-col rounded-xl overflow-hidden bg-white shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-green-100',
        large: 'group flex flex-col rounded-xl overflow-hidden bg-white shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-green-100',
        small: 'group flex flex-row rounded-lg overflow-hidden bg-white shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-green-100',
    };

    const imageClasses = {
        default: 'relative h-48 bg-gray-100 overflow-hidden',
        large: 'relative h-64 md:h-80 bg-gray-100 overflow-hidden',
        small: 'relative w-1/3 h-24 md:h-28 bg-gray-100 overflow-hidden flex-shrink-0',
    };
    ...
    const titleClasses = {
        default: 'text-lg md:text-xl font-bold text-gray-900 mb-2 group-hover:text-green-600 transition-colors duration-300 line-clamp-2',
        large: 'text-xl md:text-2xl font-bold text-gray-900 mb-3 group-hover:text-green-600 transition-colors duration-300 line-clamp-2',
        small: 'text-sm md:text-base font-bold text-gray-900 mb-1 group-hover:text-green-600 transition-colors duration-300 line-clamp-2',
    };

    const excerptClasses = {
        default: 'text-gray-600 mb-4 text-sm md:text-base line-clamp-3',
        large: 'text-gray-600 mb-5 text-base md:text-lg line-clamp-4',
        small: 'text-gray-600 text-xs md:text-sm line-clamp-2',
    };

    const dateClasses = {
        default: 'text-xs md:text-sm font-medium text-green-600 mb-2',
        large: 'text-sm md:text-base font-medium text-green-600 mb-2',
        small: 'text-xs text-gray-500 mb-1',
    };
    ...
    return (
        <div className={`${cardClasses[variant]} ${className} h-full`}>
